<?php
class ControllerVisitedFifteenMostVisitedPages extends Controller {
	private $error = array();
	...
	public function getList(){
		...
		$data['breadcrumbs'][]	=	array(
			...
			'href'	=> $this->url->link('visited/fifteen_most_visited_pages','user_token='. $this->session->data['user_token'],true)
		);
